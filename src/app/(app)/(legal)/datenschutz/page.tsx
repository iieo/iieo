    ...
    <main className="max-w-3xl mx-auto px-6 py-24 font-sans text-white/70 leading-relaxed">
      ...
      <section className="mb-10">
        ...
        <p className="mb-4 text-white/70">
          ...
          von Art. 6 Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TDDDG, soweit die Einwilligung die
      ...
      <section className="mb-10">
        ...
        <p className="mb-4 text-white/70">
          ...
          auf Grundlage von &sect; 25 Abs. 1 TDDDG. Die Einwilligung ist jederzeit widerrufbar. Sind
        ...
        <p className="mb-4 text-white/70">
          ...
          personenbezogene Daten in diese Staaten &uuml;bertragen und dort verarbeitet werden. Wir
        ...
        <p className="mb-4 text-white/70">
          ...
          Data Privacy Framework&ldquo; (DPF) besitzt oder &uuml;ber geeignete zus&auml;tzliche
          Garantien verf&uuml;gt. Informationen zu &Uuml;bermittlungen an Drittstaaten
      ...
      <section className="mb-10">
        ...
        <p className="mb-4 text-white/70">
          ...
          25 Abs. 1 TDDDG, soweit die Einwilligung die Speicherung von Cookies oder den Zugriff auf
        ...
        <p className="mb-4 text-white/70">
          ...
          wurde, erfolgt die Verarbeitung ausschlie&szlig;lich auf Grundlage von Art. 6 Abs. 1 lit.
          a DSGVO und &sect; 25 Abs. 1 TDDDG, soweit die Einwilligung die Speicherung von Cookies
